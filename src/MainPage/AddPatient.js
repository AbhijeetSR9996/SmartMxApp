    ...
    fetch('http://smart.techpanda.art/newpatient/', {
      ...
      .then(data => {
        ...
        if (existingPatient) {
          ...
          // }
          if (voice) {
        const fileStat = RNFS.stat(voice);
        const file = {
          uri: 'file://' + voice,
          name: 'recording.wav',
          type: 'audio/wav',
        ...
        formData.append('voice', file);
          ...
          return fetch('http://smart.techpanda.art/newpatient/', {
            ...
            .then(data => {
              console.log(data);
              Alert.alert('The new patient has been added successfully.');
            ...
            <View style={styles.viewContainer}>
              <SelectDropdown
                ...
                onSelect={(selectedItem, index) => {
                  ...
                  // console.log("CHECK",selectedItem.datag);
