...
const PatientDetails = ({navigation, route}) => {
  ...
  // console.log('hell11111111111111111o', patient);
  // console.log('hell11111111pdffile', patient.pdffile);
  ...
  // const errorHandiler = () => {
  //   navigation.navigate('EditForBM', {patient: patient});
  // };
    ...
    <SafeAreaView style={{flex: 1}}>
      <View style={styles.mainContainer}>
        <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
          <View
            style={{flexDirection: 'row', marginTop: 30, marginHorizontal: 17}}>
