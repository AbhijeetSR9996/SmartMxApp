...
const API_URL3 = "http://smart.techpanda.art/currentrole/";
...
const MoreDetails = ({ navigation, route }) => {
  ...
  console.log("role main data", roleData);
  ...
  console.log("shyam_11111111111", role);
  const handleSubmit = () => {
    const formData = {
      user,
      email,
    ...
    axios
      ...
      .then((response) => {
        handleDPSendRequest();
        Alert.alert("The doctor's details have been added successfully.")
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      >
        <View style={{ marginTop: 10,marginBottom:10 }}>
          <Greeting greeting={"Few More Details"} />
        </View>
        <ScrollView>
        <View
          style={{
          ...
          <View style={{ marginHorizontal: 20, marginTop: "13%" }}>
            ...
            <View style={styles.viewContainer}>
              <SelectDropdown
                data={roleData}
                onSelect={(item, index) => {
                  setRole(`${item.id}`); // assigning data to Role
                }}
                buttonStyle={styles.dropdown3BtnStyle}
                renderCustomizedButtonChild={(selectedItem, index) => {
                  return (
                    <View style={styles.dropdown3BtnChildStyle}>
                      ...
                      />
                      <Text style={styles.dropdown3BtnTxt}>
                        {selectedItem ? selectedItem.role : "Role"}
                      </Text>
                    </View>
                  );
                }}
                  ...
                  return (
                    <View style={styles.dropdown3RowChildStyle}>
                      <Image
                        ...
                        style={styles.dropdownRowImage}
                      />
                      <Text style={styles.dropdown3RowTxt}>{item.role}</Text>
                    </View>
                  );
                }}
              />
